          ...
          >
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                Cookies are small pieces of text stored on your device when you
                visit websites. They help websites remember your preferences and
                provide a better user experience. Cookies can be either session
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                ...
                cookies are being sent. Please note that blocking some cookies
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                In addition to our own cookies, we may allow third parties to
                place cookies on your device for analytics and advertising
                purposes. We encourage you to review their privacy policies to
                understand their cookie practices.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                ...
                at info@Verdant.gov.ph or call +63 (123) 456-7890.
              </p>
            </section>
          </motion.div>
        </div>
