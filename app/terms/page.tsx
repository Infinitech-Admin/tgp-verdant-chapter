          ...
          >
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                By accessing and using the Verdant Government System website,
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                ...
                materials (information or software) on Verdant Government System
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                The materials on Verdant System are provided on an 'as is'
                basis. Verdant makes no warranties, expressed or implied, and
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                In no event shall Verdantt or its suppliers be liable for any
                damages (including, without limitation, damages for loss of data
                or profit, or due to business interruption) arising out of the
                use or inability to use the materials on Verdant website.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-foreground/70">
                The materials appearing on Verdant website could include
                technical, typographical, or photographic errors. Verdant does
