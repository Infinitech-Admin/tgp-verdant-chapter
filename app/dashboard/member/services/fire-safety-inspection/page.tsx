      ...
      <div className="min-h-screen bg-linear-to-br from-orange-50 to-red-100 py-8 px-4">
        <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    ...
                    Government of Verdant does not issue FSIC. Please visit the
                    BFP Verdant Fire Station.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-3">
                  Fire Safety Inspection Certificate is a mandatory requirement
                  for:
                </p>
              ...
              <CardContent className="space-y-3">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    3-5 working days after inspection
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-sm mb-1">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    30 minutes to 2 hours (depends on establishment size)
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <p className="text-sm text-gray-600 mb-3">
                Your establishment must have the following fire safety equipment
            ...
            <CardContent>
              <div className="bg-orange-50 p-4 rounded-lg">
                <h4 className="font-semibold mb-2 flex items-center gap-2">
                  ...
                  Bureau of Fire Protection - Verdant
                </h4>
                <div className="space-y-1 text-sm text-gray-700">
                  <p>
                    <strong>Office:</strong> BFP Verdant Fire Station
                  </p>
                  <p>
                    <strong>Address:</strong> Verdant
                  </p>
                  <p>
                  ...
                  <p className="text-xs text-gray-600 mt-2">
                    Note: Contact the BFP Verdant office for exact location and
            ...
            <CardContent>
              <ol className="space-y-3">
                {[
                  ...
                  {
                    title: "Visit BFP Verdant ",
                    desc: "Go to BFP Verdant  Fire Station and submit application form with requirements",
                  },
                  {
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <p className="text-sm text-gray-600 mb-3">
                Inspection fees vary depending on establishment type, floor
                area, and building occupancy classification:
              </p>
              <div className="bg-gray-50 p-4 rounded-lg space-y-2 text-sm">
                ...
                <p className="text-xs text-gray-600 mt-3">
                  Note: Exact fees should be confirmed with BFP Verdant office
                  as rates may vary
                </p>
              </div>
            </CardContent>
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-gray-700">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    Apply at least 2 weeks before your business permit renewal
                    deadline
                  </li>
                  <li>
                    Ensure all fire safety equipment is working and accessible
                    during inspection
                  </li>
                  <li>Keep fire exits clear and properly marked</li>
                  <li>
                    Have a designated employee present during the inspection
                  </li>
