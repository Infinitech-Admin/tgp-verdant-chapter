        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Learn how to obtain your police clearance certificate in Verdant
            </p>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <CardDescription>
                    ...
                    National Police (PNP). The City Government of Verdant does
                    not issue police clearance certificates.
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <p className="text-sm text-gray-600">
                  Police clearance is a document issued by the Philippine
                  National Police (PNP) that certifies an individual has no
                  criminal record.
                </p>
                <p className="text-sm text-gray-600">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    6 months to 1 year (depending on purpose)
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-4 p-3 bg-orange-50 rounded-lg">
                  <p className="text-sm text-gray-700">
                    ...
                    complete list of requirements and fees.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="bg-orange-50 p-4 rounded-lg">
                ...
                <div className="space-y-1 text-sm text-gray-700">
                  <p>
                    <strong>Address:</strong> Verdant Police Station
                  </p>
                  <p>
                    <strong>Alternative:</strong> Visit your nearest police
                    station in your barangay
                  </p>
                  <p>
                  ...
                  <p className="text-xs text-gray-600 mt-2">
                    Note: Contact your local police station for specific
                    location, requirements, and current fees
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <ol className="space-y-3">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Go to Verdant Police Station or your barangay police station",
                  },
                  {
            ...
            <div className="flex gap-3">
              ...
              <div className="text-sm text-gray-700">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    Visit the police station early in the morning to avoid long
                    queues
                  </li>
                  <li>Bring extra photocopies of your documents</li>
                  <li>Wear decent clothing for your photo</li>
                  <li>
                    Contact the police station beforehand to confirm
                    requirements and fees
                  </li>
                  <li>
                    Police clearance validity varies by purpose - check with the
                    requesting party
                  </li>
                </ul>
              </div>
