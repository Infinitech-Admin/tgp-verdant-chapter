      ...
      items: [
        {
          ...
          content:
            "Learn how to register as a member of Verdant and access all services.",
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                To register as a member of Verdant and access all online
      ...
      items: [
        {
          ...
          content:
            "Step-by-step guide to apply for a business permit in Verdant.",
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Applying for a business permit in Verdant is now easier with our
          ...
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                ...
                or structural modification in Verdant .
              </p>
              <div className="space-y-3">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                    ...
                    <li>Proof of residency in Verdant</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">
      ...
      items: [
        ...
        },
        {
          ...
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Verdant is prone to typhoons, floods, and earthquakes. Being
              ...
              <div className="space-y-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">
                    Evacuation Centers in Verdant
                  </h4>
                  <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                    <li>Verdant Sports Complex</li>
                    <li>Verdant National High School</li>
